 ...
 * @author drag
 */
public class TranscriptDisplay extends javax.swing.JPanel {
	 ...
	 */
	public TranscriptDisplay(Student s, Transcript t) {
		this.s = s;
		this.t = t;

		initComponents();

		this.pageTitle.setText("Your transcript - job well done " + s.getUserProfile().getPerson().getFullName() + "!");
		this.studentName.setText(s.getUserProfile().getPerson().getFullName());
		this.result.setText(s.isGraduated() ? "Graduated" : "On going");
		this.gpa.setText(String.valueOf(t.getGpa()));
